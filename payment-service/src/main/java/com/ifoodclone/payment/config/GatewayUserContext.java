...
// order-service calls this service directly via Eureka (bypassing the gateway), so it
// must forward these same headers itself for POST /api/v1/payments to be reachable.
